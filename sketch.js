...
function draw() {
  ...
  fill('red');
  textSize(24);
  text("YOU ARE AT YOUR GARNDFATHER'S FARM HOUSE.", 200,200);
  text("NOW PLUCK MANGOES FROM THAT TREE!!",10,280)
  ground.display();
  tree.display();
  boy.display();
  stone.display();
